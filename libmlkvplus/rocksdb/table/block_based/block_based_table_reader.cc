...
Status ReadAndParseBlockFromFile(
  ...
  // std::cout << "[DEBUG] ReadBlockContents handle.size(): " << handle.size() << std::endl;
  // std::cout << "[DEBUG] ReadBlockContents handle.offset(): " << handle.offset() << std::endl;
  // std::cout << "[DEBUG] ReadBlockContents footer.GetBlockTrailerSize(): " << footer.GetBlockTrailerSize() << std::endl;
  // std::cout << "[DEBUG] ReadBlockContents size: " << contents.data.size() << std::endl;
  // std::cout << "[DEBUG] ReadBlockContents: " << contents.data.ToString() << std::endl;
