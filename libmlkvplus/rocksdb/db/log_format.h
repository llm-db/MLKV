...
enum RecordType : uint8_t {
  ...
  // Non-checksum record types (for WAL without CRC32)
  kNoChecksumFullType = 140, // 0x8C
  kNoChecksumFirstType = 150,
  kNoChecksumMiddleType = 160,
  kNoChecksumLastType = 170, //0xAA
  kRecyclableNoChecksumFullType = 181,
  kRecyclableNoChecksumFirstType = 191,
  kRecyclableNoChecksumMiddleType = 201,
  kRecyclableNoChecksumLastType = 211,
...
constexpr uint8_t kMaxRecordType = kRecyclableNoChecksumLastType;
...
constexpr int kNoChecksumHeaderSize = 4 + 2 + 1;

constexpr int kRecyclableNoChecksumHeaderSize = 4 + 2 + 1 + 4;
